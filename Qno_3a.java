    ...
    public static List<String> processFriendRequests(int n, int[][] restrictions, int[][] requests) {
        ...
        for (int[] request : requests) {
            ...
            if (canBeFriends) {
                ...
                results.add(" friend request can be accepted based on the current friendship network and the existing restrictions.");
            } else {
                // Otherwise, deny the request
                results.add(" friend request cannot be accepted based on the current friendship network and the existing restrictions.");
            }
        }
